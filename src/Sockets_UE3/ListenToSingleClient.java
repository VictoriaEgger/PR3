...
//Beispiel für einen Server. Server kann nur einen Client verbinden. Mit mehreren threads kann ich ich mehrere Clients bedienen
//Zuerst ListenToSingleClient ausführen hier. Dann Putty öffen und localhost port:9090 eingeben.
...
public class ListenToSingleClient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((command = bufferedReader.readLine()) != null) {
            ...
            //Commands die ich im putty eingeben kann
            if ("TIME".equals(command)) {
                ...
                bufferedWriter.newLine();
                bufferedWriter.flush();
            } else if ("JOKE".equals(command)) {
                bufferedWriter.write("Wie nennt man einen schreienden Bär auf einer Kugel? Einen Kugelschreibär."); // -> 9090
                bufferedWriter.newLine();
                bufferedWriter.flush();
